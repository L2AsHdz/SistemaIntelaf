 ...
 * @author asael
 */
public class ProductosPds extends javax.swing.JDialog {
    
    private List<ProductoPedido> productosList;
    private ObservableList<ProductoPedido> productosObservableList;
    ...
    private void initComponents() {
        ...
        tblProductosP.getTableHeader().setReorderingAllowed(false);

        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${productosObservableList}");
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, eLProperty, tblProductosP);
        ...
        columnBinding.setColumnName("Codigo Pedido");
        ...
        jTableBinding.bind();
        jScrollPane1.setViewportView(tblProductosP);
    ...
    public JTable getTblProductosP() {
        return tblProductosP;
    }

    public ObservableList<ProductoPedido> getProductosObservableList() {
        return productosObservableList;
    }

    public void setProductosObservableList(ObservableList<ProductoPedido> productosObservableList) {
